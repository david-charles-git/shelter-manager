...
<div class='<?php echo $class_name; ?>' data-conditions='<?php echo $data_conditionals; ?>'>
  ...
  <input data-type='<?php echo $input_type; ?>' type='<?php echo $input_type; ?>' name='<?php echo $input_name; ?>' id='<?php echo $input_id; ?>' placeholder='<?php echo $input_placeholder; ?>' value='<?php echo $input_value; ?>' onblur="<?php echo $on_blur; ?>" <?php echo $required_string; ?> />
